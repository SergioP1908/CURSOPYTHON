...
cursor1.execute("drop database if exists ejercicio19;")
cursor1.execute("CREATE database ejercicio19 character set latin1 collate latin1_spanish_ci;")
cursor1.execute("USE ejercicio19;")
...
cursor1.execute("LOAD DATA INFILE 'C:/ejemplos/ejercicio_19/titanic.csv' INTO TABLE pasajeros FIELDS TERMINATED BY  ';'  LINES TERMINATED BY '\n'; ")		
