...
carpeta = "C:/ejemplos/ejercicio_19/"
...
conexion1=mysql.connector.connect(host="localhost", user="root", passwd="", db="ejercicio19")
...
print("\nPorcentaje de menores salvados de 3ª Clase: " + salv_menores_3)
print("Porcentaje de mayores salvados de 3ª Clase: " + salv_mayores_3)
